# Modulistica per richiesta copia di documentazione sanitaria ULSS 9 Scaligera

*Fonte: https://www.aulss9.veneto.it/index.cfm?action=mys.page&content_id=1811*
...
Per presentare istanza scritta di accesso alla DOCUMENTAZIONE SANITARIA OSPEDALIERA, il richiedente deve compilare il modulo di richiesta on-line.  
La domanda verrà inviata automaticamente ai competenti Uffici individuati nelle diverse strutture aziendali. Terminata la fase di gestione della richiesta, il richiedente verrà contattato telefonicamente per fissare l'appuntamento per il ritiro della documentazione e il pagamento della quota dovuta.

**COMPILA LA RICHIESTA ONLINE**  
*Accesso tramite identità digitale*  
CLICCA QUI

Nel caso di ritiro allo sportello, il personale preposto accerta l'identità personale del richiedente dietro presentazione di un documento di identità valido, munito di fotografia e rilasciato da una Pubblica Autorità.  
Nel caso in cui il richiedente opti per la modalità di ritiro tramite spedizione postale o PEC, **il pagamento deve essere eseguito mediante il sistema pagoPA.** L'utente riceverà L'AVVISO DI PAGAMENTO pagoPA all'indirizzo di posta elettronica che ha indicato in fase di richiesta.  
...
Per presentare istanza scritta di accesso alla DOCUMENTAZIONE SANITARIA NON OSPEDALIERA, il richiedente deve compilare il modulo di richiesta che va inviato tramite posta o via PEC al seguente indirizzo: protocollo.aulss9@pecveneto.it  
Con tale richiesta viene rilasciata copia integrale della documentazione, fatta salva l'ipotesi di richiesta urgente. La copia autentica del documento dà garanzia della riproduzione fedele all'originale e può essere validamente prodotta e utilizzata, per quanto di interesse, in luogo del suo originale.  
  
Per ulteriori informazioni è possibile contattare i numeri indicati per ciascuna sede.
...
Ufficio Cartelle Cliniche- Accettazione Tel 045/6338213  
...
Ufficio Cartelle Cliniche- Accettazione Tel 045/6338213  
Da lunedì al venerdì dalle ore 8.00 alle ore 12.00
...
Come ritirare la documentazione
...
Come pagare le tariffe per il rilascio
...
Nel caso in cui il richiedente opti per la modalità di ritiro tramite spedizione postale o PEC, **il pagamento deve essere eseguito mediante il sistema pagoPA.**

**Vai alla pagina pago PA**

  
 L'utente riceverà L'AVVISO DI PAGAMENTO pagoPA all'indirizzo di posta elettronica che ha indicato in fase di richiesta.  
La ricevuta dell'avvenuto versamento deve essere trasmessa all'Ufficio al quale è stata inoltrata la richiesta della copia della documentazione.  
...
Tempi di rilascio della documentazione sanitaria ospedaliera
